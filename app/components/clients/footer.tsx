...
export default function Footer() {
  ...
  return (
    <footer className="relative text-cream overflow-hidden">
      ...
      {/* Newsletter Section — warm gradient background */}
      <div className="relative bg-gradient-to-br from-teak-dark via-[#4a2e18] to-teak-dark">
      ...
      {/* Main Footer */}
      <div className="bg-[#1a1008]">
        {/* Gold accent line */}
        <div className="h-px bg-gradient-to-r from-transparent via-gold-soft/30 to-transparent" />
        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-10">
            ...
            <div className="lg:col-span-4 pr-0 lg:pr-6">
              <h3 className="font-sans text-2xl font-bold text-gold-soft mb-4">
                {t("common.shopName")}
              </h3>
              ...
              <div className="pt-4 border-t border-cream/8">
                <p className="text-cream/30 text-xs uppercase tracking-widest mb-3">{t("footer.payment")}</p>
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1.5 bg-white/5 border border-cream/8 rounded-lg px-3 py-2 text-cream/50 hover:text-cream/80 hover:border-cream/15 transition-all" title="Bank Transfer">
                    <Banknote size={15} />
                    <span className="text-xs">Bank</span>
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 border border-cream/8 rounded-lg px-3 py-2 text-cream/50 hover:text-cream/80 hover:border-cream/15 transition-all" title="PromptPay">
                    <QrCode size={15} />
                    <span className="text-xs">PromptPay</span>
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 border border-cream/8 rounded-lg px-3 py-2 text-cream/50 hover:text-cream/80 hover:border-cream/15 transition-all" title="Credit/Debit Card">
                    <CreditCard size={15} />
            ...
            <div className="lg:col-span-2">
              <h4 className="text-xs font-bold text-cream/40 mb-5 uppercase tracking-[0.2em]">
                {t("footer.menu")}
              </h4>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex flex-col gap-3 text-sm">
                <a
                  ...
                  className="flex items-center gap-3 text-cream/60 hover:text-gold-soft transition-all duration-300 group py-1"
                >
                  <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-gold/10 transition-colors flex-shrink-0">
                ...
                <div className="flex items-center gap-3 text-cream/60 py-1">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="rounded-xl overflow-hidden border border-cream/8 shadow-2xl shadow-black/30 group relative h-48">
                <iframe
        ...
        <div className="border-t border-cream/6">
          <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex gap-6 text-cream/25 text-xs">
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="text-cream/50 hover:text-gold-soft transition-all duration-300 flex items-center gap-0 group w-fit py-1.5 text-sm"
    >
      <ChevronRight size={12} className="opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 text-gold-soft" />
